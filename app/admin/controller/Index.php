    ...
    public function index()
    {
        ...
        // $this->assign('ebanknum',$ebanknum);
            ...
            if($user['role_id']!=10){
                ...
                $sql2="SELECT provide_loan_money AS sum,organization FROM  ym_bank_data  ORDER BY sum desc";
                $res2 = Db::query($sql2);
                //dump($res1);die;
                $dep2 = [];
                $det2 = [];
                ...
                $sql3 = "SELECT remian_money AS sum,organization FROM ym_bank_data  ORDER BY sum desc";
                $res3 = Db::query($sql3);
                //dump($res1);die;
                $dep3 = [];
                $det3 = [];
