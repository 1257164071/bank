<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:52:"F:\www\bank.cn/app/admin\view\client\loanselect.html";i:1503994426;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1497005003;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1498812223;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1499140648;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <form action="<?php echo url('client/selectresult',array('res'=>'loan')); ?>" method="get">
                ...
                <div class="panel-body">
                    <table class="table table-border table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td >
                                <span class="select-box" >
                                    <select class="select" name="besiness_type"  >
                                        <option value="">==请选择==</option>
                                        <?php if(is_array($besiness_type) || $besiness_type instanceof \think\Collection || $besiness_type instanceof \think\Paginator): $key = 0; $__LIST__ = $besiness_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($key % 2 );++$key;?>
                                        <option value="<?php echo $key-1; ?>"><?php echo $list; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </span>
                        ...
                        <tr>
                            ...
                            <td >首贷日</td>
                            <td>
                                <input style="width: 130px;"type="text" onfocus="WdatePicker()"value=""  name="start_firstloan_time"class="input-text Wdate" >-<input type="text" style="width: 130px;" onfocus="WdatePicker()"value=""  name="end_firstloan_time"class="input-text Wdate" >
                            </td>

                            <td >主办客户经理</td>
                            <td >
                                <input type="text" class="input-text" name="main_manager"/>
                            </td>
                        </tr>
                        <tr>
                            <td>贷款账户状态</td>
                            ...
                            <td>贷款余额</td>
                            <td><input type="text" style="width: 100px;" class="input-text" name="start_remian_money"/>万元-<input type="text" style="width: 100px;" class="input-text" name="end_remian_money"/>万元</td>
                            <td>贷款用途</td>
                            <td>
                                 <span class="select-box" >
                        ...
                        <tr>
                            <td>合同金额</td>
                            <td><input type="text" style="width: 100px;" class="input-text" name="start_contract_money"/>万元-<input type="text" style="width: 100px;" class="input-text" name="end_contract_money"/>万元</td>
                            <td>发放金额</td>
                            <td><input type="text" style="width: 100px;" class="input-text" name="start_provide_money"/>万元-<input type="text" style="width: 100px;" class="input-text" name="end_provide_money"/>万元</td>
                            <td>业务编号</td>
                            <td><input type="text"  class="input-text" name="besiness_number"/></td>
                            <td colspan="2"></td>
                        </tr>
                        ...
                        <tr >
                            <td  style="text-align: center;" >
                                <div style="overflow-y: scroll;height: 180px;"id="select">
                                   ...
                                   <!-- <a href="#" id="intable-contact_money" class="btn btn-primary-outline radius hui-animation " style="width: 200px;margin-top: 5px;" data-tra="合同金额">合同金额</a><br>
-->
                                </div>
                            </td>
