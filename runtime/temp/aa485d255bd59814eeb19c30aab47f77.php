<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"F:\www\bank.cn/app/admin\view\visitrecord\add.html";i:1508122099;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<article class="cl pd-20">
    <div class="page-container">
        <form action="" method="post" class="form form-horizontal" id="form-member-add">
            <?php if(!empty($visit)&&isset($visit)): ?>

            <input type="hidden" name="id" value="<?php echo input('visit_id'); ?>" >
            <?php else: ?>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea class="textarea radius" name="content"><?php echo (isset($visit['content']) && ($visit['content'] !== '')?$visit['content']:""); ?></textarea>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function add(){
        $.ajax({
            url:'<?php echo url("visitrecord/add"); ?>',
            type:'post',
            data:$('form').serialize(),
    ...
    function edit(){
        $.ajax({
            url:'<?php echo url("visitrecord/edit"); ?>',
            type:'post',
            data:$('form').serialize(),
            success:function (data) {
                if(data.code==0){
    ...
    (function( $ ){
        ...
        $(function() {
            ...
            uploader = WebUploader.create({
                ...
                chunked: false,
                chunkSize: 512 * 1024,
                server: '<?php echo url("visitrecord/visit_upload"); ?>',
                // runtimeOrder: 'flash',
