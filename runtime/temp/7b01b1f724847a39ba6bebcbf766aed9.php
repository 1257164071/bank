<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:59:"D:\xampps\htdocs\work\bank/app/admin\view\client\caiji.html";i:1508727340;s:51:"D:\xampps\htdocs\work\bank/app/admin\view\base.html";i:1507780640;s:53:"D:\xampps\htdocs\work\bank/app/admin\view\header.html";i:1509438471;s:51:"D:\xampps\htdocs\work\bank/app/admin\view\menu.html";i:1511338586;s:53:"D:\xampps\htdocs\work\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<style type="text/css">
	...
	#DataTables_Table_0_filter input{width: 300px;}
	.table{width: 400px;}
	#DataTables_Table_0_info,#DataTables_Table_0_paginate{display: none;}
</style>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="mt-10" style="text-align: center;">
				<table class="table table-border table-bordered table-hover table-bg table-sort" style="margin: 0 auto;">
					<thead>
						<tr class="text-c">
					...
					<?php if(is_array($gridlist) || $gridlist instanceof \think\Collection || $gridlist instanceof \think\Paginator): $i = 0; $__LIST__ = $gridlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c">
							...
							<td style="text-align: left;"><?php echo mb_substr($vo['name'],0,10); ?></td>
							<td class="td-manage">
							    <a href="javascript:;" onclick="member_add('添加客户','<?php echo url('admin/client/clientadd',array('grid'=>$vo['id'])); ?>','900','510')" class="btn btn-primary radius" style="height: 25px;line-height: 25px;padding: 0 3px;">添加客户</a>
