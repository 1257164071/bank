<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:54:"D:\Xampps\htdocs\bank/app/admin\view\manage\index.html";i:1498632120;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
        ...
        <article class="cl pd-20">
            <form  method="post" action="<?php echo url('index'); ?>">
                    <div class="text-c">
                        ...
                        联系方式：<input type="text" class="input-text" style="width:150px" placeholder="手机号" value="<?php echo (isset($post['mobile']) && ($post['mobile'] !== '')?$post['mobile']:''); ?>" name="mobile">
                    ...
                    <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                        <tbody>
                            <tr class="text-c">
                                ...
                                <td>
                                   <?php if($list['client_id']!=''): ?> <a style="text-decoration:none"  href="<?php echo url('visitrecord/detail',array('client_id'=>$list['client_id'])); ?>" title="查看拜访记录详情"><i class="Hui-iconfont">&#xe720;</i>查看拜访详情</a>&nbsp;&nbsp;<?php endif; ?>
                                </td>
