<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"D:\Xampps\htdocs\bank/app/admin\view\client\clientresult.html";i:1498787441;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        ...
        <form action="<?php echo url('client/result_export'); ?>"method="post">
            ...
            <input name="selects"type="hidden" value="<?php echo $selects; ?>"/>
            <span class="l"><button class="btn btn-warning radius">导出</button> </span> <span class="r">共有数据：<strong><?php echo count($result);?></strong> 条</span>
        </form>
        </div>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <td class="td-manage"><a style="text-decoration:none"  href="<?php echo url('client/clientdetail',array('client_id'=>$list['id'])); ?>" title="查看客户详情"><i class="Hui-iconfont">&#xe725;</i>查看</a>&nbsp;&nbsp; </td>
