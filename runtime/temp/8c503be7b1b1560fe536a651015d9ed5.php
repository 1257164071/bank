<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:56:"F:\www\bank.cn/app/admin\view\dataconfig\configlist.html";i:1498817434;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1511338586;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 配置列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="Hui-article">
		<article class="cl pd-20">

			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="javascript:" onclick="layer_show('添加配置','/admin/dataconfig/configadd','600','370')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加配置</a></span>  </div>
			<div class="mt-10">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<tbody>
					<?php if(is_array($dataconfig) || $dataconfig instanceof \think\Collection || $dataconfig instanceof \think\Paginator): $i = 0; $__LIST__ = $dataconfig;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c">
							...
							<td class="td-manage"> <a  href="javascript:" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i>删除</a>
								<a href="javascript:" onclick="layer_show('修改配置','<?php echo url('admin/dataconfig/configadd',array('id'=>$vo['id'])); ?>','600','370')"><i class="Hui-iconfont"></i>编辑</a>
							</td>
