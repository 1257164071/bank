<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:49:"F:\www\bank.cn/app/admin\view\grid\gridlists.html";i:1512032977;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1511338586;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray"> 
				<span class="l"> 
					<a href="javascript:" onclick="layer_show('添加小区','/admin/grid/gridadds','600','370')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加小区</a>
				</span>  
				<span class="r">
					<strong><?php echo count($gridlist); ?></strong>个小区
				</span>
			</div>
			<div class="mt-10">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<?php if(is_array($gridlist) || $gridlist instanceof \think\Collection || $gridlist instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($gridlist) ? array_slice($gridlist,1,null, true) : $gridlist->slice(1,null, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c">
							...
							<a href="<?php echo url('admin/grid/wangge',['id'=>$vo['id']]); ?>"><?php echo $vo['name']; ?></a>
							<!-- <?php echo $vo['name']; ?> -->
							</td>
