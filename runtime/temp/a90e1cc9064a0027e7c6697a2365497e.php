<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:60:"F:\www\bank.cn/app/admin\view\visitrecord\activezhunbei.html";i:1512463008;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1511338586;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
    ...
    <h4 style=" text-align: center;">活动准备和费用</h4>
    <div style="width: 1000px;margin: 0 auto;">
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>详情</span>
                <a href="javascript:;" onclick="submit('添加活动准备和费用','<?php echo url('activezhunbei_add',array('activity_id'=>$activity_id)); ?>','','510')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></div>
            <div class="panel-body">
                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <td><?php echo $list['zb_cailiao']; ?></td>
                        <td><?php echo $list['activity_spend']; ?></td>
                        <td><?php echo date('Y-m-d',$list['add_time']); ?></td>
                        <td class="td-manage">
                            <a href="javascript:;" onclick="submit('修改活动准备','<?php echo url('activezhunbei_edit',array('id'=>$list['id'])); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;
                            <a style="text-decoration:none"  href="<?php echo url('activezhunbei_del',array('id'=>$list['id'])); ?>" title="删除活动准备"><i class="Hui-iconfont">&#xe6e2;</i>删除</a>&nbsp;&nbsp;
