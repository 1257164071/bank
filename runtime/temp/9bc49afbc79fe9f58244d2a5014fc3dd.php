<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:52:"F:\www\bank.cn/app/admin\view\client\depositres.html";i:1506503266;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1508406189;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1507856679;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <form action="<?php echo url('client/deposit_export'); ?>"method="post">
                <textarea name="where" style="display: none"><?php echo $where; ?></textarea>
                <textarea name="selects" style="display: none"><?php echo $selects; ?></textarea>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <th width="80"><?php echo get_name('search_code',$v); ?></th>
                        <?php endforeach; ?>
                        <th width="120">操作</th>
                    </tr>
                    ...
                    <tr class="text-c">
                        ...
                        <td><?php echo $list[$v]; ?></td>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <td class="td-manage"><a style="text-decoration:none"  href="<?php echo url('client/clientdetail',array('client_id'=>$list['client_id'])); ?>" title="查看客户详情"><i class="Hui-iconfont">&#xe725;</i>查看客户</a>&nbsp;&nbsp;&nbsp;&nbsp;
                           
                        <!-- <a href="javascript:;" onclick="submit('查看','<?php echo url('admin/deposit/detail',array('deposit_id'=>$list['id'])); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe720;</i>存款详情</a>&nbsp; -->
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
