<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:55:"D:\Xampps\htdocs\bank/app/admin\view\deposit\index.html";i:1498794946;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:52:"D:\Xampps\htdocs\bank/app/admin\view\clientmenu.html";i:1498124849;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
  ...
  <span class="btn <?php if($controller == 'Picupload'): ?>btn-primary<?php else: ?>btn-default<?php endif; ?> radius"><a href="<?php echo url('picupload/index',array('client_id'=>$client[0]['id'])); ?>">附件上传</a></span>
    ...
    <div style="width: 1200px; margin: 0 auto;">
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>存款信息</span><a href="javascript:;" onclick="submit('添加存款信息','<?php echo url('Deposit/add',array('client_id'=>$client[0]['id'])); ?>','','710')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></div>
                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $list['save_amt']; ?></td>
                            <td><?php echo $list['bankname']; ?></td>
                            <td><?php if($list['account_status']==0): ?>正常<?php else: ?>冻结<?php endif; ?></td>
                            <td><?php if($list['deposit_type']==1): ?>活期存款 <?php elseif($list['deposit_type']==2): ?>整存整取<?php elseif($list['deposit_type']==3): ?>零存整取<?php elseif($list['deposit_type']==4): ?>整存零取<?php elseif($list['deposit_type']==5): ?>存本取息<?php elseif($list['deposit_type']==6): ?>定活两便<?php elseif($list['deposit_type']==7): ?>通知存款<?php endif; ?></td>
                            <td><?php echo date('Y-m-d',$list['save_time']); ?></td>
                            <td><?php echo $list['real_name']; ?></td>
                            <td class="td-manage">
                            <!-- 
                            <a href="javascript:;" onclick="submit('修改存款信息','<?php echo url('deposit/edit',array('deposit_id'=>$list['id'])); ?>','','710')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;
                             -->
                            <a style="text-decoration:none"  href="javascript:;" onclick="msg_del(this,'<?php echo $list['id']; ?>')" title="删除存款信息"><i class="Hui-iconfont">&#xe6e2;</i>删除</a> </td>
                        </tr>
                    </tbody>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </table>
...
function msg_del(obj,id){
	layer.confirm('删除须谨慎，确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: "<?php echo url('admin/deposit/del'); ?>",
			dataType: 'json',
			data:'id='+id,
