<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"F:\www\bank.cn/app/admin\view\credit\index.html";i:1508741970;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1507856679;s:45:"F:\www\bank.cn/app/admin\view\clientmenu.html";i:1509427022;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
  ...
  <span class="btn <?php if($controller == 'Picupload'): ?>btn-primary<?php else: ?>btn-default<?php endif; ?> radius"><a href="<?php echo url('picupload/index',array('client_id'=>$client['id'])); ?>">附件上传</a></span>
        ...
        <h4 style=" text-align: center;">授信用信信息详情</h4>
    <div style="padding:0 20px; margin: 0 auto;">
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>授信用信信息</span><a href="javascript:;" onclick="submit('添加授信用信信息','<?php echo url('credit/add',array('client_id'=>$client['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></div>
            <div class="panel-body">
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <?php if(is_array($credit) || $credit instanceof \think\Collection || $credit instanceof \think\Paginator): $i = 0; $__LIST__ = $credit;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$credit): $mod = ($i % 2 );++$i;?>
                    <tbody>
                    <tr class="text-c">
                        <td><?php if(!empty($credit['credit_type'])&&$credit['credit_type'] == 1): ?>表内授信<?php else: ?>表外授信<?php endif; ?></td>
                        <td><?php echo $credit['use_way']; ?></td>
                        <td><?php echo $credit['credit_money']; ?></td>
                        <td><?php echo $credit['cate_range']; ?></td>
                        <td><?php echo date('Y-m-d',$credit['credit_start_time']); ?></td>
                        <td><?php echo date('Y-m-d',$credit['credit_end_time']); ?></td>
                        <td><?php echo $credit['manager']; ?></td>
                        <td><?php echo $credit['bankname']; ?></td>
                        <td class="td-manage" style="text-align: center;">
                        <a href="javascript:;" onclick="submit('修改授信用信信息','<?php echo url('credit/edit',array('id'=>$credit['id'])); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;
                        <a style="text-decoration:none"  href="<?php echo url('credit/del',array('id'=>$credit['id'])); ?>" title="删除授信用信信息"><i class="Hui-iconfont">&#xe6e2;</i>删除</a> </td>
                    </tr>
                    </tbody>
