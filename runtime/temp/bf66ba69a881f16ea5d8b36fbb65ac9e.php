<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:47:"F:\www\bank.cn/app/admin\view\grid\allgrid.html";i:1508118785;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1508126064;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1507856679;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 网格列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="Hui-article">
		<article class="cl pd-20">

			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="javascript:" onclick="layer_show('添加小区','/admin/grid/gridadds','600','370')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加小区</a></span>  </div>
			<div class="mt-10">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<tbody>
					<?php if(is_array($gridlist) || $gridlist instanceof \think\Collection || $gridlist instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($gridlist) ? array_slice($gridlist,1,null, true) : $gridlist->slice(1,null, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-l">
							<td style="display:none;"><input type="checkbox" value="<?php echo $vo['id']; ?>" name="id[]"></td>
							<td><?php echo $vo['id']; ?></td>
							<td><a href="<?php echo url('admin/grid/wangge',['id'=>$vo['id']]); ?>"><?php echo $vo['name']; ?></a></td>
							<td><?php if($vo['gridtype'] == 1): ?>村镇<?php else: ?>小区<?php endif; ?></td>
							
							<td><?php echo $vo['manger_name']; ?></td>
							<td class="td-manage"> <!-- <a  href="javascript:" class="ml-5" style="text-decoration:none;"><i class="Hui-iconfont">&#xe6e2;</i>删除</a> -->
								<a href="javascript:" onclick="layer_show('修改小区','/admin/grid/gridadds/id/<?php echo $vo['id']; ?>','600','370')"><i class="Hui-iconfont"></i>编辑</a>
							</td>
						</tr>
