<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:50:"F:\www\bank.cn/app/admin\view\picupload\index.html";i:1508742059;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1507856679;s:45:"F:\www\bank.cn/app/admin\view\clientmenu.html";i:1509427022;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
  ...
  <span class="btn <?php if($controller == 'Picupload'): ?>btn-primary<?php else: ?>btn-default<?php endif; ?> radius"><a href="<?php echo url('picupload/index',array('client_id'=>$client['id'])); ?>">附件上传</a></span>
    ...
    <div>
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>附件信息</span><a href="javascript:;" onclick="submit('添加附件信息','<?php echo url('picupload/add',array('client_id'=>$client['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></div>
            <div class="panel-body">
                <!--<table class="table table-border table-bordered table-hover">-->
                    <!--<tr class="text-c">-->
                        <!--<td style="width: 55px;">客户名称</td><td style="width: 200px;"><?php echo $client['name']; ?></td>-->
                        <!--<td style="width: 55px;">所属机构</td><td style="width: 200px;"><?php echo $client['bankname']; ?></td>-->
                    <!--</tr>-->
                    <!--<tr class="text-c">-->
                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <?php if(is_array($pic) || $pic instanceof \think\Collection || $pic instanceof \think\Paginator): $i = 0; $__LIST__ = $pic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                    <tbody>
                        <tr class="text-c">
                            <td><?php echo $list['id']; ?></td>
                            <td><img style="width: 100px;height: 100px;" src="<?php echo $list['picurl']; ?>"/></td>
                            <td><?php echo $list['content']; ?></td>
                            <td><?php echo date('Y-m-d',$list['add_time']); ?></td>

                            <!--<td class="td-manage" style="text-align: center;"><a href="javascript:;" onclick="submit('修改附件信息','<?php echo url('picupload/edit',array('personcredit_id'=>$list['id'])); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;<a style="text-decoration:none"  href="<?php echo url('picupload/del',array('personcredit_id'=>$list['id'])); ?>" title="删除附件信息"><i class="Hui-iconfont">&#xe6e2;</i>删除</a> </td>-->
                            <td class="td-manage" style="text-align: center;">
                                <a style="text-decoration:none"  href="<?php echo url('detail',array('pic_id'=>$list['id'])); ?>" title="查看"><i class="Hui-iconfont">&#xe725;</i>查看</a>&nbsp;&nbsp;

                                <a style="text-decoration:none"  href="<?php echo url('picupload/del',array('pic_id'=>$list['id'])); ?>" title="删除附件信息"><i class="Hui-iconfont">&#xe6e2;</i>删除</a> </td>
