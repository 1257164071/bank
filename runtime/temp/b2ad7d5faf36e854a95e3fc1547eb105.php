<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:59:"D:\Xampps\htdocs\bank/app/admin\view\client\clientlist.html";i:1498817434;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<form  method="post" action="<?php echo url('clientlist'); ?>">
			<div class="text-c" style="line-height: 40px;"> 日期范围：
				...
				<input type="text" class="input-text" style="width:250px" placeholder="客户编号" value="<?php echo (isset($post['client_number']) && ($post['client_number'] !== '')?$post['client_number']:''); ?>"  name="client_number">
				...
				<span class="select-box" style="width: 350px;line-height: 21px;">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-10">
				...
				<span class="r">共有数据：<strong><?php echo count($clients);?></strong> 条</span>
				</div>
				...
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<?php if(is_array($clients) || $clients instanceof \think\Collection || $clients instanceof \think\Paginator): $i = 0; $__LIST__ = $clients;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$clients): $mod = ($i % 2 );++$i;?>
						...
						<td><input type="checkbox" value="<?php echo $clients['id']; ?>" name="id[]"></td>
							...
							<td><?php if($clients['card_type']==0): ?>身份证<?php else: ?>其他<?php endif; ?></td>
							<td><?php echo $clients['card_number']; ?></td>
							<td><?php if($clients['sex']==0): ?>女<?php else: ?>男<?php endif; ?></td>
							<td><?php echo $clients['address']; ?></td>
							<td><?php echo $clients['current_address']; ?></td>
							<td><?php echo get_name('client_grade',$clients['client_grade']); ?></td>
							<td class="text-l"><?php echo $clients['phone_number']; ?></td>
							<td class="td-manage">
								...
								<a title="删除客户" href="<?php echo url('del',array('client_id'=>$clients['id'])); ?>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i>删除</a></td>
