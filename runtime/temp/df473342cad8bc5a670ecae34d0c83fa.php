<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:59:"D:\Xampps\htdocs\bank/app/admin\view\visitrecord\lists.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <form action="<?php echo url('lists'); ?>" method="post">
                <div class="text-c">
                    拜访时间：
                    ...
                    <tbody>
                        <tr class="text-c">
                            ...
                            <td class="f-14 td-manage">
                                <?php if(empty($list['status'])): ?> <a  class="btn btn-success radius" href="javascript:;" onclick="submit('添加申请','<?php echo url('apply',array('client_id'=>$list['client_id'],'user_id'=>$user['id'],'id'=>$list['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe692;</i>申请</a><?php else: ?><a class="btn btn-warning radius" href="<?php echo url('applydetail',array('record_id'=>$list['id'])); ?>" ><i class="Hui-iconfont">&#xe695;</i>审批</a><?php endif; ?>&nbsp;&nbsp;&nbsp;&nbsp;
                                <a style="text-decoration:none"  href="<?php echo url('detail',array('client_id'=>$list['client_id'])); ?>" title="查看拜访记录详情"><i class="Hui-iconfont">&#xe720;</i>查看拜访详情</a>&nbsp;&nbsp;
                            </td>
                        </tr>
                    </tbody>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
