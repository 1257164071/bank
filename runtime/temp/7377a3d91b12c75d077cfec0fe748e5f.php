<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:59:"D:\Xampps\htdocs\bank/app/admin\view\action\listaction.html";i:1498817434;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont"></i> 首页 <span class="c-gray en">&gt;</span> 行为管理 <span class="c-gray en">&gt;</span> 行为列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont"></i></a></nav>
    <div class="Hui-article">
        <article class="cl pd-20">


            <div class="cl pd-5 bg-1 bk-gray">
                <span class="l f-20 text-success">行为列表</span>
                <span class="r">
                <a class="btn btn-primary" href="<?php echo url('addaction'); ?>">新 增</a>
                </span>
            </div>
            <div class="mt-10 clearfix">
                    <table class="table table-border table-bordered table-bg">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo url('Action/editAction?id='.$vo['id']); ?>">编辑</a>
                                <!--<a href="<?php echo url('Action/setStatus?Model=action&status=-1&ids='.$vo['id']); ?>" class="confirm ajax-get">删除</a>-->
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        </tbody>
