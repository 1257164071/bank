<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:52:"D:\Xampps\htdocs\bank/app/admin\view\sign\index.html";i:1499151088;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:52:"D:\Xampps\htdocs\bank/app/admin\view\clientmenu.html";i:1498124849;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
  ...
  <span class="btn <?php if($controller == 'Picupload'): ?>btn-primary<?php else: ?>btn-default<?php endif; ?> radius"><a href="<?php echo url('picupload/index',array('client_id'=>$client[0]['id'])); ?>">附件上传</a></span>
    ...
    <div style="width: 1000px;margin: 0 auto;">
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>签约信息</span><a href="javascript:;" onclick="submit('添加签约信息','<?php echo url('sign/add',array('client_id'=>$client[0]['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></div>
            <div class="panel-body">
                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <?php if(is_array($sign) || $sign instanceof \think\Collection || $sign instanceof \think\Paginator): $i = 0; $__LIST__ = $sign;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                    <tbody>
                    <tr class="text-c">
                        <td><?php echo $list['sign_website_number']; ?></td>
                        <td><?php echo $list['bankname']; ?></td>
                        <td><?php if(!empty($list['sign_type'])): ?><?php echo get_name('sign_type',$list['sign_type']); endif; ?></td>
                        <td><?php echo date('Y-m-d',$list['sign_time']);; ?></td>
                        <td><?php echo $list['other_account_content']; ?></td>
                        <td class="td-manage"><a href="javascript:;" onclick="submit('修改签约信息','<?php echo url('sign/edit',array('sign_id'=>$list['id'])); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;<a style="text-decoration:none"  href="<?php echo url('sign/del',array('sign_id'=>$list['id'])); ?>" title="删除签约信息"><i class="Hui-iconfont">&#xe6e2;</i>删除</a> </td>
                    </tr>
                    </tbody>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </table>
