<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:53:"F:\www\bank.cn/app/admin\view\familymember\index.html";i:1509522924;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1511338586;s:45:"F:\www\bank.cn/app/admin\view\clientmenu.html";i:1509427022;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
  ...
  <span class="btn <?php if($controller == 'Picupload'): ?>btn-primary<?php else: ?>btn-default<?php endif; ?> radius"><a href="<?php echo url('picupload/index',array('client_id'=>$client['id'])); ?>">附件上传</a></span>
    ...
    <div>
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>家庭成员信息</span><a href="javascript:;" onclick="submit('添加成员信息','<?php echo url('familymember/add',array('client_id'=>$client['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></div>
            <div class="panel-body">
                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tbody>
                        <tr class="text-c">
                            <td><?php echo $list['members_name']; ?></td>
                            <td><?php echo $list['members_relation']; ?></td>
                            <td><?php echo $list['builder']; ?></td>
                            <td><?php echo date('Y-m-d',$list['add_time']);; ?></td>
                            <td class="td-manage"><a href="javascript:;" onclick="show('查看成员信息','<?php echo url('familymember/member_show',array('member_id'=>$list['id'])); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe725;</i>查看</a>&nbsp;&nbsp;<a href="javascript:;" onclick="submit('修改成员信息','<?php echo url('familymember/edit',array('member_id'=>$list['id'])); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;<a style="text-decoration:none"  href="<?php echo url('familymember/del',array('member_id'=>$list['id'])); ?>" title="删除成员"><i class="Hui-iconfont">&#xe6e2;</i>删除</a> </td>
                        </tr>
                    </tbody>
    ...
    <div style="text-align: center;">
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>配偶信息</span><?php if(!empty($spouse_info)&&(isset($spouse_info))): ?>  <span><a href="javascript:;" onclick="submit('编辑配偶信息','<?php echo url('familymember/spouseedit',array('client_id'=>$client['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;<a href="<?php echo url('familymember/spousedel',array('client_id'=>$client['id'])); ?>"  ><i class="Hui-iconfont">&#xe6e2;</i>删除</a></span><?php else: ?><span><a href="javascript:;" onclick="submit('添加配偶信息','<?php echo url('familymember/spouseadd',array('client_id'=>$client['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></span><?php endif; ?></div>
            <div class="panel-body">
                <?php if(is_array($spouse_info) || $spouse_info instanceof \think\Collection || $spouse_info instanceof \think\Paginator): $i = 0; $__LIST__ = $spouse_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$spouse): $mod = ($i % 2 );++$i;?>
                <table class="table table-border table-bordered table-hover">
                    <tr>
                        <td style="width: 55px;">配偶名称</td><td style="width: 200px;"><?php echo (isset($spouse['spouse_name']) && ($spouse['spouse_name'] !== '')?$spouse['spouse_name']:''); ?></td>
                        <td style="width: 55px;">性别</td><td style="width: 200px;"><?php if($spouse['spouse_sex']==0): ?>女<?php else: ?>男<?php endif; ?></td>

                    </tr>
                    <tr>
                        <td>证件类型</td><td><?php if($spouse['card_type']==0): ?>身份证<?php else: ?>其他<?php endif; ?></td>
                        <td>证件号码</td><td><?php echo (isset($spouse['card_number']) && ($spouse['card_number'] !== '')?$spouse['card_number']:''); ?></td>
                    </tr>
                    <tr>
                        <td>出生日期</td><td><?php echo date('Y-m-d',$spouse['born_date']); ?></td>
                        <td>住址</td><td><?php echo (isset($spouse['address']) && ($spouse['address'] !== '')?$spouse['address']:''); ?></td>
                    </tr>
                    <tr>
                        <td>签发机关</td><td><?php echo (isset($spouse['issue_office']) && ($spouse['issue_office'] !== '')?$spouse['issue_office']:''); ?></td>
                        <td>有效期限</td><td><?php echo date('Y-m-d',$spouse['valid_time']); ?></td>
                    </tr>

                    <tr>
                        <td>联系方式（手机）</td><td><?php if(!empty($spouse['tel_number'])): ?><?php echo $spouse['tel_number']; endif; ?></td>
                        <td>联系方式（电话）</td><td><?php if(!empty($spouse['phone_number'])): ?> <?php echo $spouse['phone_number']; endif; ?></td>
                    </tr>
                    <tr>
                        <td>工作单位</td><td><?php echo (isset($spouse['work_place']) && ($spouse['work_place'] !== '')?$spouse['work_place']:''); ?></td>
                        <td>从事职业</td><td><?php echo (isset($spouse['professional']) && ($spouse['professional'] !== '')?$spouse['professional']:''); ?></td>
                    </tr>
                    <tr>
                        <td>健康状况</td><td colspan="3"><?php if((!empty($spouse['physical_condition']))): ?><?php echo get_name('physical_condition',$spouse['physical_condition']); endif; ?></td>
