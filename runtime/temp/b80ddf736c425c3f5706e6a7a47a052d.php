<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"F:\www\bank.cn/app/admin\view\picupload\add.html";i:1499500248;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    function add(){
        $.ajax({
            url:'<?php echo url("picupload/add"); ?>',
            type:'post',
            data:$('form').serialize(),
    ...
    (function( $ ){
        ...
        $(function() {
            ...
            uploader = WebUploader.create({
                ...
                chunked: false,
                chunkSize: 512 * 1024,
                server: '<?php echo url("Picupload/upload"); ?>',
                // runtimeOrder: 'flash',
