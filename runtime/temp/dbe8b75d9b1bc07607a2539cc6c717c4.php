<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"F:\www\bank.cn/app/admin\view\client\pic_upload.html";i:1496989688;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-list-container"style="width: 400px;height: 260px;">
                    ...
                    <div class="statusBar" style="display:none;">
                        ...
                        <div class="btns">
                            <!--<div id="filePicker2" class="webuploader-container"><div class="webuploader-pick">继续添加</div><div id="rt_rt_1bhtguap1hvlh8a1lj76pk1t939" style="position: absolute; top: 0px; left: 0px; width: 38px; height: 2px; overflow: hidden; bottom: auto; right: auto;"><input name="file" class="webuploader-element-invisible" multiple="multiple" type="file"><label style="opacity: 0; width: 100%; height: 100%; display: block; cursor: pointer; background: rgb(255, 255, 255) none repeat scroll 0% 0%;"></label></div></div>-->
...
<script type="text/javascript">
    ...
    var uploader = WebUploader.create({
        ...
        // 文件接收服务端。
//        server: 'http://ymbank.com/static/lib/webuploader/0.1.5/server/fileupload.php',
        server: "<?php echo url('client/pic_upload'); ?>",
        // 选择文件的按钮。可选。
...
//                server: 'http://ymbank.com/static/lib/webuploader/0.1.5/server/fileupload.php',
            ...
            uploader.on('uploadSuccess',function(file,response){
                if(response.code==0){
                    var input='<input type="hidden" name="pic_url" value="'+response.data.pic_url+'"/>';
                    $('#picurl').append( input);
                }
            });
      ...
      function add(){
    	  ...
    	  $.ajax({
    		  url:'<?php echo url("client/uploadpost"); ?>',
    		  type:'post',
    		  data:$('form').serialize(),
