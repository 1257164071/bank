<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:53:"F:\www\bank.cn/app/admin\view\visitrecord\detail.html";i:1508491387;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1511338586;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 营销管理<span class="c-gray en">&gt;</span>拜访记录详情<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:history.go(-1);" title="返回" >返回</a></nav>


    <h4 style=" text-align: center;">客户拜访记录</h4>
    <div style="width: 1000px;margin: 0 auto;">
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>客户拜访记录详情</span><a href="javascript:;" onclick="submit('添加拜访记录','<?php echo url('add',array('client_id'=>input('client_id'),'user_id'=>$user['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></div>
            <div class="panel-body">
                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $key = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($key % 2 );++$key;?>
                    <tbody>
                    <tr class="text-c">
                        ...
                        <td><?php echo date('Y-m-d',$list['visit_time']); ?></td>
                        <td><?php echo date('Y-m-d',$list['add_time']); ?></td>
                        <td class="td-manage"><a href="javascript:;" onclick="submit('修改拜访记录','<?php echo url('edit',array('visit_id'=>$list['id'])); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;<a style="text-decoration:none"  href="<?php echo url('del',array('visit_id'=>$list['id'])); ?>" title="删除拜访记录"><i class="Hui-iconfont">&#xe6e2;</i>删除</a>&nbsp;&nbsp;<a href="<?php echo url('visit_detail',array('visit_id'=>$list['id'])); ?>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe725;</i>查看</a> </td>
