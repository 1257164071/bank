<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:46:"F:\www\bank.cn/app/admin\view\grid\manger.html";i:1505185958;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1508145607;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1507856679;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 经理小区管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="Hui-article">
        <article class="cl pd-20">
        
                <?php if(is_array($manger) || $manger instanceof \think\Collection || $manger instanceof \think\Paginator): if( count($manger)==0 ) : echo "" ;else: foreach($manger as $key=>$vo): ?>
            <div class="panel panel-default" style="margin-bottom:1%; ">
                <div class="panel-header" style="display: flex;justify-content: space-between;"><a href="javascript:"  class="btn btn-success radius"> <?php echo $vo['real_name']; ?></a></div>
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-border table-bordered table-hover">
                        ...
                        <tr>
                        <?php if(is_array($vo['xiaoqu']) || $vo['xiaoqu'] instanceof \think\Collection || $vo['xiaoqu'] instanceof \think\Paginator): if( count($vo['xiaoqu'])==0 ) : echo "" ;else: foreach($vo['xiaoqu'] as $key=>$item): ?>
                            <td><a href="<?php echo url('admin/grid/wangge',['id'=>$item['id']]); ?>" target="_blank"><?php echo $item['name']; ?></a></td>
