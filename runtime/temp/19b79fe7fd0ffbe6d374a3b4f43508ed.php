<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:57:"D:\Xampps\htdocs\bank/app/admin\view\admin\rolelists.html";i:1498812222;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','<?php echo url('admin/admin/roleadd'); ?>','600','370')"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a> </span>  </div>
			<div class="mt-10">
				...
				<tbody>
				   <?php if(is_array($msglist) || $msglist instanceof \think\Collection || $msglist instanceof \think\Paginator): $i = 0; $__LIST__ = $msglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$msg): $mod = ($i % 2 );++$i;?>
					<tr class="text-c">
						...
						<td style="text-align:left;"><?php echo $msg['remark']; ?></td>
						<td><?php if($msg['status'] == 1): ?>开启<?php else: ?>关闭<?php endif; ?></td>
						<td class="f-14">
						<a style="text-decoration:none" href="javascript:;" onclick="msg_edit('配置权限','<?php echo url('admin/admin/access',array('rid'=>$msg['id'])); ?>','1','800','500')" title="配置权限"><i class="Hui-iconfont">&#xe725;</i>配置权限</a>&nbsp;&nbsp;
						<a title="编辑" href="javascript:;" onclick="msg_edit('编辑','<?php echo url('admin/admin/roleedit',array('id'=>$msg['id'])); ?>','1','600','370')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i> 编辑</a>
						<!-- <a title="删除客户" href="javascript:;" onclick="msg_del(this,'<?php echo $msg['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i>删除</a>-->
						</td> 
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
...
function msg_del(obj,id){
	layer.confirm('删除须谨慎，确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '<?php echo url('admin/admin/roledel'); ?>',
			dataType: 'json',
			data:'id='+id,
