<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:52:"F:\www\bank.cn/app/admin\view\grid\clientmanger.html";i:1512022175;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1511338586;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <h4 class="text-c"><?php echo $name; ?>管理的小区</h4><br/>
            <div class="mt-10">
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tbody>
                    <?php if(is_array($grid) || $grid instanceof \think\Collection || $grid instanceof \think\Paginator): $i = 0; $__LIST__ = $grid;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr class="text-c">
