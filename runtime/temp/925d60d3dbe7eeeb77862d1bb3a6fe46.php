<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:46:"F:\www\bank.cn/app/admin\view\action\edit.html";i:1499135197;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1511338586;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
        ...
        <article class="cl pd-20">
            ...
            <form id="form" method="post" class="form form-horizontal">
                ...
                <div id="tab1" class="tab-pane in tab1">
                    <div class="row cl">
                        <label class="form-label col-xs-2 col-sm-2">行为名称</label>
                        <div  class="formControls col-xs-10 col-sm-10">
                            <span><?php echo get_action($info['action_id'], "title"); ?></span>
                        </div>
                    </div>
                    <div class="row cl">
                        <label class="form-label col-xs-2 col-sm-2">执行者</label>
                        <div  class="formControls col-xs-10 col-sm-10">
                            <span><?php echo $info['real_name']; ?></span>
                        </div>
                    </div>
                    <div class="row cl">
                        <label class="form-label col-xs-2 col-sm-2">执行IP</label>
                        <div  class="formControls col-xs-10 col-sm-10">
                            <span><?php echo long2ip($info['action_ip']); ?></span>
                        </div>
                    </div>
                    <div class="row cl">
                        <label class="form-label col-xs-2 col-sm-2">时间</label>
                        <div  class="formControls col-xs-10 col-sm-10">
                    ...
                    <div class="row cl">
                        ...
                        <div  class="formControls col-xs-10 col-sm-10">
                                <textarea class="textarea" readonly="readonly"><?php echo $info['remark']; ?></textarea>
                        </div>
                    </div>
                </div>
