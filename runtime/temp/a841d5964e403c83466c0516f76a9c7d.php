<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:52:"F:\www\bank.cn/app/admin\view\client\signselect.html";i:1504679708;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1507778616;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1507856679;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <form action="<?php echo url('client/selectresult',array('res'=>'sign')); ?>" method="get">
                ...
                <div class="panel-body">
                    <table class="table table-border table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>签约时间</td>
                            <td>
                                <input style="width: 40%;"type="text" onfocus="WdatePicker()"value=""  name="start_sign_time"class="input-text Wdate" >-<input type="text" style="width: 40%;" onfocus="WdatePicker()"value=""  name="end_sign_time"class="input-text Wdate" >
                            </td>
                            <td>客户评级</td>
                            <td>
                                <span class="select-box" >
