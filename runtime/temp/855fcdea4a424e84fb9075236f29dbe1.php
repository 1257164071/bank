<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"F:\www\bank.cn/app/admin\view\visitrecord\apply.html";i:1498632120;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<article class="cl pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        <?php if(!empty($apply)&&isset($apply)): ?>
        ...
        <input type="hidden" name="record_id" value="<?php echo input('id'); ?>" >
        <?php endif; ?>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea class="textarea radius" name="apply_content"><?php echo (isset($apply['apply_content']) && ($apply['apply_content'] !== '')?$apply['apply_content']:""); ?></textarea>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function add(){
        $.ajax({
            url:'<?php echo url("Visitrecord/apply"); ?>',
            type:'post',
            data:$('form').serialize(),
    ...
    function edit(){
        $.ajax({
            url:'<?php echo url("Visitrecord/applyedit"); ?>',
            type:'post',
            data:$('form').serialize(),
            success:function (data) {
                if(data.code==0){
