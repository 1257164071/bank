<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:54:"F:\www\bank.cn/app/admin\view\client\clientresult.html";i:1511432229;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1511338586;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        ...
        <form action="<?php echo url('client/clientresult_export'); ?>"method="post">
            ...
            <span class="r"><strong><?php echo (isset($count) && ($count !== '')?$count:''); ?></strong> 个客户</span>
        </form>
        </div>
        ...
        <article class="cl pd-20">
            <div class="mt-20">
               <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tbody>
                    <?php if(is_array($result) || $result instanceof \think\Collection || $result instanceof \think\Paginator): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$clients): $mod = ($i % 2 );++$i;?>
                        <tr class="text-c">
