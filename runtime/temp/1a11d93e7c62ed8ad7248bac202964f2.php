<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:60:"D:\xampps\htdocs\work\bank/app/admin\view\grid\banktree.html";i:1512373009;s:51:"D:\xampps\htdocs\work\bank/app/admin\view\base.html";i:1507780640;s:53:"D:\xampps\htdocs\work\bank/app/admin\view\header.html";i:1509438471;s:51:"D:\xampps\htdocs\work\bank/app/admin\view\menu.html";i:1511338586;s:53:"D:\xampps\htdocs\work\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<style type="text/css">
    ...
    #map{max-width:500px;margin:0 auto 20px 30%;}
</style>
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 网格列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:history.go(-1);" title="返回" >返回</a></nav>
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="mt-10">

                <img style="max-height: 300px;" src="/static/wangge/images/<?php echo $id; ?>.png" alt="" border="0" id="map"/>
                <table class="table table-border table-bordered table-hover table-bg table-sort" >
                    ...
                    <tbody>
                    <?php if(is_array($client_manger) || $client_manger instanceof \think\Collection || $client_manger instanceof \think\Paginator): $i = 0; $__LIST__ = $client_manger;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr class="text-c">

                        <td><?php echo $vo['id']; ?></td>
                        <td><a href="<?php echo url('clientmanger',array('manger_id'=>$vo['id'],'name'=>$vo['real_name'])); ?>"><?php echo $vo['real_name']; ?></a></td>
                        <td>
                            <?php if(is_array($vo['grid_name']) || $vo['grid_name'] instanceof \think\Collection || $vo['grid_name'] instanceof \think\Paginator): if( count($vo['grid_name'])==0 ) : echo "" ;else: foreach($vo['grid_name'] as $key=>$values): ?>
                            <a class="btn btn-primary-outline radius" href="<?php echo url('grid/wangge',array('id'=>$values['id'])); ?>"><?php echo $values['name']; ?></a> 
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </td>
                        <td><?php echo $vo['grid']; ?></td>
