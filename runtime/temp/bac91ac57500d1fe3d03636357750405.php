<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:66:"D:\Xampps\htdocs\bank/app/admin\view\visitrecord\activedetail.html";i:1499334671;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 营销活动<span class="c-gray en">&gt;</span>活动详情<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="Hui-article">



        <h4 style=" text-align: center;">活动详情</h4>
        <div style="width: 1000px; margin: 0 auto">
            <div class="panel panel-default">
                <div class="panel-header" style="display: flex;justify-content: space-between;"><span>营销活动</span></div>
                <div class="panel-body">

                        <table class="table table-border table-bordered table-hover">
                            <tr class="text-c">
                                <td style="width: 55px;">组织人</td><td style="width: 200px;"><?php echo $activity['real_name']; ?></td>
                                <td style="width: 55px;">举行时间</td><td style="width: 200px;"><?php echo date('Y-m-d',$activity['hold_time']); ?></td>
                            </tr>
                            <tr class="text-c">
                                <td style="width: 55px;">标题</td><td colspan="3" style="width: 200px;"><?php echo $activity['title']; ?></td>
                            </tr>
                            <tr class="text-c">
                                <td style="width: 55px;">摘要</td><td  colspan="3" style="width: 200px;"><?php echo $activity['description']; ?></td>
                            </tr>
                        </table>
            ...
            <div class="panel panel-default">
                <div class="panel-header" style="display: flex;justify-content: space-between;"><span>活动照片</span></div>
                <div class="panel-body">
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                    <table class="table table-border table-bordered table-hover">
                    <tr class="text-c">
                        <td ><img src="<?php echo $vo; ?>"/></td>
