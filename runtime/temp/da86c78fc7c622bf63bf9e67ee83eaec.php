<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:60:"D:\Xampps\htdocs\bank/app/admin\view\familymember\index.html";i:1498458805;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:52:"D:\Xampps\htdocs\bank/app/admin\view\clientmenu.html";i:1498124849;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
  ...
  <span class="btn <?php if($controller == 'Picupload'): ?>btn-primary<?php else: ?>btn-default<?php endif; ?> radius"><a href="<?php echo url('picupload/index',array('client_id'=>$client[0]['id'])); ?>">附件上传</a></span>
    ...
    <div style="width: 1000px; margin: 0 auto;">
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>家庭成员信息</span><a href="javascript:;" onclick="submit('添加成员信息','<?php echo url('familymember/add',array('client_id'=>$client[0]['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></div>
                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tbody>
                        <tr class="text-c">
                            ...
                            <td class="td-manage"><a href="javascript:;" onclick="submit('修改成员信息','<?php echo url('familymember/edit',array('member_id'=>$list['id'])); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;<a style="text-decoration:none"  href="<?php echo url('familymember/del',array('member_id'=>$list['id'])); ?>" title="删除成员"><i class="Hui-iconfont">&#xe6e2;</i>删除</a> </td>
                        </tr>
                    </tbody>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </table>
    ...
    <div style="width: 1000px; margin: 0 auto;">
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>配偶信息</span><?php if(!empty($spouse_info)&&(isset($spouse_info))): ?>  <span><a href="javascript:;" onclick="submit('编辑配偶信息','<?php echo url('familymember/spouseedit',array('client_id'=>$client[0]['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;<a href="<?php echo url('familymember/spousedel',array('client_id'=>$client[0]['id'])); ?>"  ><i class="Hui-iconfont">&#xe6e2;</i>删除</a></span><?php else: ?><span><a href="javascript:;" onclick="submit('添加配偶信息','<?php echo url('familymember/spouseadd',array('client_id'=>$client[0]['id'])); ?>','','510')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></span><?php endif; ?></div>
            <div class="panel-body">
                ...
                <table class="table table-border table-bordered table-hover">
                    <tr>
                        <td style="width: 55px;">配偶名称</td><td style="width: 200px;"><?php echo $spouse['spouse_name']; ?></td>
                    ...
                    <tr>
                        ...
                        <td>证件号码</td><td><?php echo $spouse['card_number']; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>工作单位</td><td colspan="3"><?php echo $spouse['work_place']; ?></td>
                    </tr>
                </table>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
