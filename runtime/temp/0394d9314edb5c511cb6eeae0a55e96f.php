<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:58:"D:\Xampps\htdocs\bank/app/admin\view\familyfund\index.html";i:1498817434;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;s:48:"D:\Xampps\htdocs\bank/app/admin\view\header.html";i:1498812223;s:46:"D:\Xampps\htdocs\bank/app/admin\view\menu.html";i:1499140648;s:52:"D:\Xampps\htdocs\bank/app/admin\view\clientmenu.html";i:1498124849;s:48:"D:\Xampps\htdocs\bank/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 客户信息<span class="c-gray en">&gt;</span>资产信息<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
  ...
  <span class="btn <?php if($controller == 'Picupload'): ?>btn-primary<?php else: ?>btn-default<?php endif; ?> radius"><a href="<?php echo url('picupload/index',array('client_id'=>$client[0]['id'])); ?>">附件上传</a></span>
    ...
    <h4 style=" text-align: center;">资产信息详情</h4>
   
    <div style="width:100%;margin: 0 auto;padding:10px;">
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>资产信息</span>
            <?php if(isset($clients) && !empty($clients)): ?>
            <a href="javascript:;" onclick="submit('修改资产信息','<?php echo url('admin/familyfund/edit',array('id'=>$clients['id'])); ?>','','810')" ><i class="Hui-iconfont">&#xe600;</i>修改</a></div>
            <?php else: ?>
            <a href="javascript:;" onclick="submit('添加资产信息','<?php echo url('admin/familyfund/add',array('client_id'=>$client_id)); ?>','','810')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></div>
            <?php endif; ?>
            <div class="panel-body">
                 <table class="table table-border table-bordered table-hover">
                    <tr class="text-c">
                    	<td style="width:50%;">股票基金类</td>
                    	<td><?php echo (isset($clients['fund']) && ($clients['fund'] !== '')?$clients['fund']:""); ?></td>
                    </tr>
                    <tr class="text-c">
                    	<td>股票基金类-查控:</td>
                    	<td><?php if(isset($clients['fund_ck_date']) && ($clients['fund_ck_date'] > 0)): ?>已查控-<?php echo date("Y-m-d",$clients['fund_ck_date']); endif; ?> </td>
                    </tr>
                     <tr class="text-c">
                    	<td style="width:50%;">房产类</td>
                    	<td><?php echo (isset($clients['house']) && ($clients['house'] !== '')?$clients['house']:""); ?></td>
                    </tr>
                     <tr class="text-c">
                    	<td>房产类-查控:</td>
                    	<td><?php if(isset($clients['house_ck_date']) && ($clients['house_ck_date'] > 0)): ?>已查控-<?php echo date("Y-m-d",$clients['house_ck_date']); endif; ?> </td>
                    </tr>
                     <tr class="text-c">
                    	<td style="width:50%;">车产类</td>
                    	<td><?php echo (isset($clients['car']) && ($clients['car'] !== '')?$clients['car']:""); ?></td>
                    </tr>
                     <tr class="text-c">
                    	<td>车产类-查控:</td>
                    	<td><?php if(isset($clients['car_ck_date']) && ($clients['car_ck_date'] > 0)): ?>已查控-<?php echo date("Y-m-d",$clients['car_ck_date']); endif; ?> </td>
                    </tr>
                     <tr class="text-c">
                    	<td style="width:50%;">地产类</td>
                    	<td><?php echo (isset($clients['land']) && ($clients['land'] !== '')?$clients['land']:""); ?></td>
                    </tr>
                     <tr class="text-c">
                    	<td>地产类-查控:</td>
                    	<td><?php if(isset($clients['land_ck_date']) && ($clients['land_ck_date'] > 0)): ?>已查控-<?php echo date("Y-m-d",$clients['land_ck_date']); endif; ?> </td>
                    </tr>
                     <tr class="text-c">
                    	<td style="width:50%;">设备存货类类</td>
                    	<td><?php echo (isset($clients['device']) && ($clients['device'] !== '')?$clients['device']:""); ?></td>
                    </tr>
                     <tr class="text-c">
                    	<td>设备存货类-查控:</td>
                    	<td><?php if(isset($clients['device_ck_date']) && ($clients['device_ck_date'] > 0)): ?>已查控-<?php echo date("Y-m-d",$clients['device_ck_date']); endif; ?> </td>
                    </tr>
            </div>
        </div>
    </div>
