<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\Xampps\htdocs\bank/app/admin\view\grid\gridadds.html";i:1499335652;s:46:"D:\Xampps\htdocs\bank/app/admin\view\base.html";i:1497005003;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<article class="cl pd-20">
    ...
    <form action="" method="post" class="form form-horizontal">
        ...
        <div class="row cl">
            <label class="form-label col-xs-2 col-sm-2"><span class="c-red"></span>管理人</label>
            <div class="formControls col-xs-10 col-sm-10">
                <select name="user_id" id="user_id">
                     <option value="0">==请选择==</option>
	                <?php if(is_array($alluser) || $alluser instanceof \think\Collection || $alluser instanceof \think\Paginator): if( count($alluser)==0 ) : echo "" ;else: foreach($alluser as $k=>$vo): if(isset($vo['level'])): ?>
	                     <option disabled="disabled"><?php echo $vo['level']; ?></option>
	                     <?php endif; ?>
	                     <option value="<?php echo $vo['id']; ?>" <?php if(isset($grid) && $vo['id'] == $grid['user_id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['real_name']; ?></option>
...
<script type="text/javascript">
  ...
  function gridadd(){
      ...
      $.ajax({
		  ...
		  type:'post',
		  data:{id:gridid,name:gridname,remark:gridremark,user_id:user_id,sort:gridsort},
