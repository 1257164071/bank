<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:59:"F:\www\bank.cn/app/admin\view\visitrecord\activeresult.html";i:1512455147;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1507780640;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1509438471;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1511338586;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<div class="Hui-article-box">
    ...
    <h4 style=" text-align: center;">活动的效果和心得</h4>
    <div style="width: 1000px;margin: 0 auto;">
        <div class="panel panel-default">
            <div class="panel-header" style="display: flex;justify-content: space-between;"><span>详情</span>
                <a href="javascript:;" onclick="submit('添加活动的效果和心得','<?php echo url('activeresult_add',array('activity_id'=>$activity_id)); ?>','','510')" ><i class="Hui-iconfont">&#xe600;</i>添加</a></div>
            <div class="panel-body">
                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <th width="200">活动效果</th>
                        <th width="200">活动心得</th>
                    ...
                    <tr class="text-c">
                        ...
                        <td><a href="<?php echo url('visit_detail',array('visit_id'=>$list['id'])); ?>"><?php echo $list['title']; ?></a></td>
                        <td><?php echo $list['activity_result']; ?></td>
                        <td><?php echo $list['activity_xinde']; ?></td>
                        <td><?php echo date('Y-m-d',$list['add_time']); ?></td>
                        <td class="td-manage">
                            <a href="javascript:;" onclick="submit('修改活动的效果和心得','<?php echo url('activeresult_edit',array('id'=>$list['id'])); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>编辑</a>&nbsp;&nbsp;
                            <a style="text-decoration:none"  href="<?php echo url('activeresult_del',array('id'=>$list['id'])); ?>" title="删除活动的效果和心得"><i class="Hui-iconfont">&#xe6e2;</i>删除</a>&nbsp;&nbsp;
                            <!-- <a href="<?php echo url('visit_detail',array('visit_id'=>$list['id'])); ?>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe725;</i>查看</a> </td> -->
