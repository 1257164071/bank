...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <h4 class="text-c">罗庄农村商业银行</h4>
            <div class="text-r"><span class="btn btn-success radius"><?php echo $count; ?>个</span></div>
            <div class="mt-10">
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <td><a href="<?php echo url('admin/grid/banktree',array('bank_id'=>$vo['id'])); ?>"><?php echo $vo['bankname']; ?></a></td>
