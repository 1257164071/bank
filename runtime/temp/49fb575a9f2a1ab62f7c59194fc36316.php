<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:51:"F:\www\bank.cn/app/admin\view\analyse\charts_1.html";i:1503047306;s:39:"F:\www\bank.cn/app/admin\view\base.html";i:1497005003;s:41:"F:\www\bank.cn/app/admin\view\header.html";i:1498812223;s:39:"F:\www\bank.cn/app/admin\view\menu.html";i:1499140648;s:41:"F:\www\bank.cn/app/admin\view\footer.html";i:1495788367;}*/ ?>
<!DOCTYPE HTML>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 数据分析 <span class="c-gray en">&gt;</span> 存贷款走势 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="Hui-article">

		<article class="cl pd-20">

			<span class="dropDown dropDown_hover">
				<a class="dropDown_A btn" data-toggle="dropdown" ><?php echo $bankname; ?></a>
				<ul class="dropDown-menu menu radius box-shadow">
					<li><a href="<?php echo url('admin/Analyse/charts_1'); ?>"> 所有银行 </a></li>
					<?php if(is_array($banklist) || $banklist instanceof \think\Collection || $banklist instanceof \think\Paginator): $i = 0; $__LIST__ = $banklist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<li><a href="<?php echo url('admin/Analyse/charts_1',['bankid'=>$vo['id'],'bankname'=>$vo['bankname']]); ?>"> <?php echo $vo['bankname']; ?> </a></li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
			...
			<div id="chart1" style="min-width:700px;height:400px"></div>
